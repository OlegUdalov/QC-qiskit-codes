...
init_circuit = CZ_gate() * gates_product(U3_gate(theta_1, phi_1, lambda_1), U3_gate(theta_2, phi_2, lambda_2)) * CZ_gate();% * gates_product(sx_gate(), sx_gate());
...
for i_try = 1:1
    ...
    IterRec = @(params) (circ_diff_1(theta_1,phi_1,lambda_1, params));
    for i = 1:12
        params0(i)=pi*rand(1);
    end
    ...
    dd(i_try) = circ_diff_1(theta_1,phi_1,lambda_1, params_fin);
%     for i = 1:6
